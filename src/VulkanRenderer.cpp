...
VulkanRenderer::VulkanRenderer(
	...
	: commandBuffer(commandBuffer), swapChainExtent(swapChainExtent), renderPass(renderPass) , swapChainFramebuffers(swapChainFramebuffers), graphicsPipeline(graphicsPipeline), device(device) {}
